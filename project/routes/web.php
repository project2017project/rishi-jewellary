...
// Verification Section Ends
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  //------------ ADMIN SLIDER SECTION ENDS ------------
    ...
    //------------ ADMIN ACCESSORIES SLIDER SECTION ------------

  Route::get('/accessories-slider/datatables', 'Admin\AccessoriesSliderController@datatables')->name('admin-accsl-datatables'); //JSON REQUEST
  Route::get('/accessories-slider', 'Admin\AccessoriesSliderController@index')->name('admin-accsl-index');
  Route::get('/accessories-slider/create', 'Admin\AccessoriesSliderController@create')->name('admin-accsl-create');
  Route::post('/accessories-slider/create', 'Admin\AccessoriesSliderController@store')->name('admin-accsl-store');
  Route::get('/accessories-slider/edit/{id}', 'Admin\AccessoriesSliderController@edit')->name('admin-accsl-edit');
  Route::post('/accessories-slider/edit/{id}', 'Admin\AccessoriesSliderController@update')->name('admin-accsl-update');
  Route::get('/accessories-slider/delete/{id}', 'Admin\AccessoriesSliderController@destroy')->name('admin-accsl-delete');

  //------------ ADMIN ACCESSORIES SLIDER SECTION ENDS ------------
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/checkout/payment/returncod', 'Front\PaymentController@payreturncod')->name('payment.returncod');
