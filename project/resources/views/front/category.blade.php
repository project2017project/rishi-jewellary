    ...
    @include('includes.catalog')
     ...
     <div class="col-12 col-sm-12 col-md-12 col-lg-9 main-col">
       <div class="page-title text-left">
        <h1 class="text-left">
          @if (!empty($cat)){{ $cat->name }}  @endif
          @if (!empty($subcat)) &nbsp; | &nbsp; {{ $subcat->name }} @endif
          @if (!empty($childcat)) &nbsp; | &nbsp; {{ $childcat->name }} @endif
          @if (empty($childcat) && empty($subcat) && empty($cat)) &nbsp; | &nbsp; {{ $langg->lang36 }} @endif
        </h1>
      </div>
