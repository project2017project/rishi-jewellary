...
<div class="breadcrumbs-wrapper text-uppercase">
                    <div class="container">
                        <div class="breadcrumbs">
                          ...
                          <span>|</span>
                          <a href="{{ route('front.checkout') }}">{{ $langg->lang136 }}</a>
		...
		<div class="col-lg-6">
			<div class="customer-box hiraola-section_title">
            <h3 class="rounded-1 mb-3"><i class="me-2 icon an an-user"></i>Billing & Shipping Address <a href="#customer-login" id="customer" class="text-white fw-bolder" data-bs-toggle="collapse"></a></h3>
        </div>
      ...
      <div class="col-lg-12">
		 ...
		 -->
												<div class="col-lg-6 d-none form-group col-md-6 col-lg-6" id="shipshow">
												...
												<div class="col-lg-6 form-group col-md-6 col-lg-6">
                        ...
                        <div class="tab-content d-block mt-4 tab-2-text-wrap" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-step1" role="tabpanel" aria-labelledby="pills-step1-tab">
        ...
        <!-- <div class="hiraola-section_title">
            <h4>Shipping Info</h4>
                                            ...
                                            <div class="hiraola-product_area hiraola-product_area-2 section-space_add" style="padding-top: 0px; padding-bottom: 0;">
            <div class="container">
                <div class="row">
        <div class="hiraola-section_title">
...
@endif
				...
				@if(Session::has('cart'))
				<div class="col-lg-6 check-right-wrap checkout-area ">
                ...
                <input type="hidden" id="user_id" value="{{ Auth::check() ? Auth::user()->id : '' }}">
						        <input type="text" class="coupon-total" placeholder="{{ $langg->lang133 }}" id="code" required="" autocomplete="off">
                                                <span class="input-group__btn">
                                                   <button type="submit" class="btn rounded-end text-nowrap">{{ $langg->lang134 }}</button>
                                                </span>
                                            </div>
                                        </div>
