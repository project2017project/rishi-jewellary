...
<div class="work-maintain-wrapper">
    <div class="working-title">
        <p>Website is under maintenance
</p>
    </div>
</div>
...
<header class="header header--2 header--2-full" data-sticky="true" style="background-image:url('{{asset('img/sem-banner.jpg')}}'); background-color: #f1d7d6!important;">

        <div class="navigation">

             <div class="navigation__center"><a class="ps-logo" href="{{ route('front.index') }}"><img src="{{asset('assets/images/'.$gs->logo)}}" alt=""></a></div>
                ...
                <ul class="menu desktop-menu">          
                    ...
                    @php
											...
											<li  class="menu-item-has-children {{ $category->slug }}">
												...
												<a href="{{ route('front.category',$category->slug) }}">{{ $category->name }} </a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
												...
												@if(count($subcat->childs) > 0)
														...
														<ul class="inner-sub-menu">
															...
															<li class="innner-li-sub"><a href="{{ route('front.childcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug, 'slug3' => $childcat->slug]) }}">{{$childcat->name}}</a>
            ...
            <div class="navigation__right">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item-has-children"><a href="blog-fullwidth.html">Blog</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                ...
                <div class="header__actions">
                    ...
                    <div class="ps-cart">
                        ...
                        <a class="ps-cart__toggle" href="javascript:;" data-bs-toggle="modal" data-bs-target="#minicart-drawer">

                            <span id="cart-count"><i>{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</i></span>
...
<li  class="lvl1 parent dropdown">
	...
	<a href="{{ route('front.category',$category->slug) }}">{{ $category->name }} <i class="an an-angle-down-l"></i></a>
	...
	<ul class="dropdown">
		...
		<li class="menu-item menu-item-has-children">
			...
			<a class="site-nav" href="{{ route('front.subcat',['slug1' => $subcat->category->slug, 'slug2' => $subcat->slug]) }}">{{$subcat->name}} <i class="an an-angle-right-l"></i></a>

			@else



			<a class="site-nav" href="{{ route('front.subcat',['slug1' => $subcat->category->slug, 'slug2' => $subcat->slug]) }}">{{$subcat->name}} </a>
			...
			<ul class="dropdown">
				...
				<li class="menu-item"><a class="site-nav" href="{{ route('front.childcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug, 'slug3' => $childcat->slug]) }}">{{$childcat->name}}</a>
...
.my-float{
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12  ">
                            ...
                            <div class="ps-site-info">
                                ...
                                <p>Our products are painstakingly created to exude the spirit of femininity and elegance while emphasising a woman's body's curves and contours</p>

                                <figure>

                                    <p><i class="icon-paperplane"></i> C-29, C Block, Sector 6, Noida, Uttar Pradesh 201301</p>

                                    <p><i class="icon-phone"></i> +91-9310726427 </p>

                                    <p><i class="icon-envelope-o"></i><a href="mailto:info@revoue.com">info@revoue.com</a></p>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12  ">
                            ...
                            <div class="widget widget_footer widget_footer-posts">
                                ...
                                <div class="ps-post--footer">
                                    ...
                                    <div class="ps-post__thumbnail"><a href="#"><img src="{{ $blogg->photo ? asset('assets/images/blogs/'.$blogg->photo):asset('assets/images/noimage.png') }}" alt=""></a></div>

                                    <div class="ps-post__content"><a href="{{route('front.blogshow',$blogg->id)}}">{{mb_strlen($blogg->title,'utf-8') > 40 ? mb_substr($blogg->title,0,40,'utf-8')."...":$blogg->title}}</a>
            ...
            <div class="ps-footer__copyright">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12  "><a class="ps-logo" href="{{ route('front.index') }}"><img src="{{asset('assets/images/'.$gs->footer_logo)}}" alt=""></a>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12  ">
                            ...
                            <div class="ps-footer__social">
                                ...
                                <ul class="ps-list--social">
                                    ...
                                    <li><a class="facebook" href="{{ $socialsetting->facebook }}"><i class="icon-facebook2"></i></a></li>

                                    @endif

                                     @if($socialsetting->t_status == 1)

                                    <li><a class="twitter" href="{{ $socialsetting->twitter }}"><i class="icon-twitter"></i></a></li>

                                    @endif

                                    @if($socialsetting->d_status == 1)

                                    <li><a class="instagram" href="{{ $socialsetting->dribble }}"><i class="icon-instagram"></i></a></li>

                                    @endif

                                     @if($socialsetting->g_status == 1)

                                    <li><a class="vimeo" href="{{ $socialsetting->gplus }}"><i class="icon-vimeo"></i></a></li>

                                    @endif

                                    @if($socialsetting->l_status == 1)

                                    <li><a class="linkedin" href="{{ $socialsetting->linkedin }}"><i class="icon-linkedin2"></i></a></li>
	...
	<div class="menubar-mobile d-flex align-items-center justify-content-between d-lg-none">
		...
		<div class="menubar-shop menubar-item">
			...
			<a href="{{ route('front.index') }}/category"><i class="menubar-icon an an-th-large-l"></i><span class="menubar-label">Shop</span></a>
		...
		<div class="menubar-cart menubar-item">
			...
			<a href="javascript:;" class="cartBtn" data-bs-toggle="modal" data-bs-target="#minicart-drawer">
				...
				<span class="span-count position-relative text-center"><span class="menubar-icon an an-sq-bag"></span><span class="menubar-count counter d-flex-center justify-content-center position-absolute translate-middle rounded-circle cart-quantity" id="cart-countm">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</span></span>
