                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Minimum Cart Quantity</h4>
                                <!--<p class="sub-heading">{{ __('(In Any Language)') }}</p>-->
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="cart_qty" id="qu" placeholder="Minimum Cart Quantity" required="" value="{{$data->cart_qty}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Minimum Cart Value</h4>
                                <!--<p class="sub-heading">{{ __('(In Any Language)') }}</p>-->
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="cart_value" id="val" placeholder="Minimum Cart Value" required="" value="{{$data->cart_value}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="description" id="desc" placeholder="Description" required="" value="{{$data->description}}">
                          </div>
                        </div>
