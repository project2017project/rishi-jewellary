                    ...
                    <div class="product-description">
                      ...
                      @include('includes.admin.form-both') 
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Slider Position*</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                                <select  name="slider_position">
                                      <option value="1" {{ $data->slider_position == '1' ? 'selected':'' }}>Top</option>
                                      <option value="2" {{ $data->slider_position == '2' ? 'selected':'' }}>Bottom</option>
                                </select>
                          </div>
                        </div>
