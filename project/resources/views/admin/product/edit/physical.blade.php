													...
													<h4 class="heading">{{ __('Product Colors') }}</h4>
															...
															<div class="feature-tag-top-filds" id="feature-section">
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" name="features[]" class="input-field" placeholder="{{ __('Product Url') }}" value="{{ $data->features[$key] }}">
																		</div>
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" name="features[]" class="input-field" placeholder="{{ __('Product Url') }}">
																		</div>
															...
															<a href="javascript:;" id="feature-btn" class="add-fild-btn"><i class="icofont-plus"></i> {{ __('Add More Colors') }}</a>
														</div>
													</div>
												</div>
