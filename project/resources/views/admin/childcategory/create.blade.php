                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-childcat-create')}}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						   <input type="text" class="input-field" name="meta_title" placeholder="{{ __('Enter Meta Title') }}"  value="">                            
                          </div>
                        </div>
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						   <input type="text" class="input-field" name="meta_keyword" placeholder="{{ __('Enter Meta Keyword') }}" value="">                            
                          </div>
                        </div>
