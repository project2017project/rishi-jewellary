                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3">
                                    <div class="left-area">
                                        ...
                                        <p class="sub-heading">It will display on Home Page</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <textarea name="about_content" class="input-field">{{$gs->about_content}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3">
                                    <div class="left-area">
                                        <h4 class="heading">About Image 1</h4>
                                        <p class="sub-heading">It will display on Home Page</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <input class="img-upload1" type="file" name="about_image1">
                                        <img src="{{ $gs->about_image1 ? asset('assets/images/'.$gs->about_image1):asset('assets/images/noimage.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3">
                                    <div class="left-area">
                                        <h4 class="heading">About Image 2</h4>
                                        <p class="sub-heading">It will display on Home Page</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <input class="img-upload1" type="file" name="about_image2">
                                        <img src="{{ $gs->about_image2 ? asset('assets/images/'.$gs->about_image2):asset('assets/images/noimage.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3">
                                    <div class="left-area">
                                        <h4 class="heading">Featured Product Content *</h4>
                                        <p class="sub-heading">It will display on Home Page</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <textarea name="featured_content" class="input-field">{{$gs->featured_content}}</textarea>
                                    </div>
                                </div>
