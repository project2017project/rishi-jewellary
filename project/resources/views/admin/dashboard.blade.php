...
<div class="content-area">
  ...
  <div class="row row-cards-one">
        <div class="col-md-6 col-xl-3">
            <div class="card bg-info text-center" style="color:#ffffff;">
                <div style="padding: 20px;">
                    <div class="dash-icon-card" style="color:#ffffff;" class="h1" > <i style="font-size: 55px;" class="fa fa-user"></i></div>
                    <h3 style="color:#ffffff; margin: 10px;">{{ App\Models\User::where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->get()->count()  }}</h3>
                    <h6 class="title" style="color:#eeeeee;">{{ __('New Customers') }}</h6>
                    <p class="text" style="color:#eeeeee;">{{ __('Last 30 Days') }}</p>
                </div>
            </div>
        </div>

        <div class="col-md-6 col-xl-3">
            <div class="card bg-warning text-center" style="color:#ffffff;">
                <div style="padding: 20px;">
                    <div class="dash-icon-card" style="color:#ffffff;" class="h1" > <i style="font-size: 55px;" class="fa fa-users"></i></div>
                    <h3 style="color:#ffffff; margin: 10px;">{{ App\Models\User::count() }}</h3>
                    <h6 class="title" style="color:#eeeeee;">{{ __('Total Customers') }}</h6>
                    <p class="text" style="color:#eeeeee;">{{ __('All Time') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-danger text-center" style="color:#ffffff;">
               
                <div style="padding: 20px;">
                    <div class="dash-icon-card" style="color:#ffffff;" class="h1" > <i style="font-size: 55px;" class="icofont-dollar"></i></div>
                    <h3 style="color:#ffffff; margin: 10px;">{{ App\Models\Order::where('status','=','completed')->where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->get()->count()  }}</h3>
                    <h6 class="title" style="color:#eeeeee;">{{ __('Total Sales') }}</h6>
                    <p class="text" style="color:#eeeeee;">{{ __('Last 30 days') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-success text-center" style="color:#ffffff;">
                <!-- <div class="c-info-box box1">
                    <p>{{ App\Models\User::where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->get()->count()  }}</p>
                </div> -->
                <div style="padding: 20px;">
                    <div class="dash-icon-card" style="color:#ffffff;" class="h1" > <i style="font-size: 55px;" class="icofont-cart-alt"></i></div>
                    <h3 style="color:#ffffff; margin: 10px;">{{ App\Models\Order::where('status','=','completed')->get()->count() }}</h3>
                    <h6 class="title" style="color:#eeeeee;">{{ __('Total Sales') }}</h6>
                    <p class="text" style="color:#eeeeee;">{{ __('All Time') }}</p>
                </div>
            </div>
