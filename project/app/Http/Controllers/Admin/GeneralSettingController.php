...
class GeneralSettingController extends Controller
{
    ...
    [
        ...
        'about_image1'      => 'mimes:jpeg,jpg,png,svg',
        'about_image2'      => 'mimes:jpeg,jpg,png,svg',
    ];
    ...
    public function generalupdate(Request $request)
    {
        ...
        $data = Generalsetting::findOrFail(1);
            ...
            if ($file = $request->file('about_image1'))
            {
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->about_image1);
                $input['about_image1'] = $name;
            }
            
            if ($file = $request->file('about_image2'))
            {
                $name = time().str_replace(' ', '', $file->getClientOriginalName());
                $data->upload($name,$file,$data->about_image2);
                $input['about_image2'] = $name;
            }
