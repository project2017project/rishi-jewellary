...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $accessories_sliders = DB::table('accessories_sliders')->get();
        $sliders = DB::table('sliders')->where('slider_position','=',2)->get();
        $sliders_top = DB::table('sliders')->where('slider_position','=',1)->get();
        ...
        $feature_products =  Product::with('user')->where('featured','=',1)->where('status','=',1)->select($selectable)->orderBy('id','desc')->take(3)->get()->reject(function($item){
           ...
           $latest_products =  Product::with('user')->where('latest','=',1)->where('status','=',1)->select($selectable)->orderBy('id','desc')->take(8)->get()->reject(function($item){
	    ...
	    return view('front.index',compact('ps','sliders','sliders_top', 'accessories_sliders', 'top_small_banners','feature_products','bottom_small_banners','latest_products','ps'));
	}
    ...
    public function extraIndex()
    {
        ...
        return view('front.extraindex',compact('ps','services','reviews','large_banners','bottom_small_banners','best_products','top_products','hot_products','top_small_banners','latest_products','big_products','trending_products','sale_products','discount_products','partners','feature_products'));
    }
