...
class CartController extends Controller
{
    ...
    public function cart()
    {
        ...
        return view('front.cart', compact('products','totalPrice','mainTotal','tx','coupans', 'cart')); 
    }
   ...
   public function addtocart($id)
    {
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name','sku','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
